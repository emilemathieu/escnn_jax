...
class O2(Group):
    ...
    def _subgroup(self, id: Tuple[float, int]) -> Tuple[
        ...
        if id[0] is not None and id[1] == -1:
            ...
            sg = escnn_jax.group.dihedral_group(order)
...
def o2_to_so2(so2: Union[escnn_jax.group.SO2, escnn_jax.group.CyclicGroup]):
...
def so2_to_o2(o2: O2):
    ...
    def _map(e: GroupElement, o2=o2):
        assert isinstance(e.group, escnn_jax.group.SO2) or isinstance(e.group, escnn_jax.group.CyclicGroup)
        return o2.element(
...
def o2_to_flip(axis: float, flip: escnn_jax.group.CyclicGroup):
    assert isinstance(flip, escnn_jax.group.CyclicGroup) and flip.order() == 2
...
def flip_to_o2(axis: float, o2: O2):
    ...
    def _map(e: GroupElement, axis=axis, o2=o2):
        assert isinstance(e.group, escnn_jax.group.CyclicGroup) and e.group.order() == 2
...
def o2_to_dn(axis: float, dn: escnn_jax.group.DihedralGroup):
    assert isinstance(dn, escnn_jax.group.DihedralGroup)
...
def dn_to_o2(axis: float, o2: O2):
    ...
    def _map(e: GroupElement, axis=axis, o2=o2):
        assert isinstance(e.group, escnn_jax.group.DihedralGroup)
