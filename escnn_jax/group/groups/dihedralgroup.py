...
from escnn_jax.group import IrreducibleRepresentation, Representation
...
def dn_to_cn(cn: escnn_jax.group.CyclicGroup):
...
def cn_to_dn(dn: DihedralGroup):
    ...
    def _map(e: GroupElement, dn=dn):
        assert isinstance(e.group, escnn_jax.group.CyclicGroup)
...
def dn_to_flip(axis: int, flip: escnn_jax.group.CyclicGroup):
...
def dn_to_dm(axis: int, dm: escnn_jax.group.DihedralGroup):
    assert isinstance(dm, escnn_jax.group.DihedralGroup)
