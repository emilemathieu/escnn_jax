...
import escnn_jax
from escnn_jax.group._numerical import find_intertwiner_basis_sylvester, build_sylvester_constraint
from escnn_jax.group._numerical import InsufficientIrrepsException
...
def _clebsh_gordan_tensor(J: Tuple, l: Tuple, j: Tuple, group_class: str, **group_keys) -> np.ndarray:
    ...
    G = escnn_jax.group.groups_dict[group_class]._generator(**group_keys)
...
def check_spherical_harmonics():
    ...
    from escnn_jax.group import SO3
    from escnn_jax.group.groups.so3group import spherical_harmonic
