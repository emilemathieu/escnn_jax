...
from escnn_jax.group import Group, GroupElement, IrreducibleRepresentation
...
class DirectProductGroup(Group):
    ...
    def __init__(self, G1: str, G2: str, name: str = None, **groups_keys):
        ...
        self._G1 = escnn_jax.group.groups_dict[G1]._generator(**g1_keys)
        self._G2 = escnn_jax.group.groups_dict[G2]._generator(**g2_keys)
    ...
    def irrep(self, id1: Tuple, id2: Tuple, i: int = 0) -> escnn_jax.group.IrreducibleRepresentation:
        r"""
