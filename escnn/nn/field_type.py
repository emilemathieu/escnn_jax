...
import escnn_jax.nn
from escnn_jax.group import Group, GroupElement, Representation, directsum
from escnn_jax.gspaces import GSpace
...
class FieldType:
    ...
    def __call__(self, tensor: torch.Tensor, coords: torch.Tensor = None) -> 'escnn_jax.nn.GeometricTensor':
        return escnn_jax.nn.GeometricTensor(tensor, self, coords)
