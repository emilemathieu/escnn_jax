...
class R3ConvTransposed(_RdConvTransposed):
    ...
    def check_equivariance(self, atol: float = 0.1, rtol: float = 0.1, assertion: bool = True, verbose: bool = True):
        ...
        shrink1 = escnn_jax.nn.PointwiseAvgPoolAntialiased3D(self.in_type, sigma=5. / 3, stride=5, padding=5)
        shrink2 = escnn_jax.nn.PointwiseAvgPoolAntialiased3D(self.out_type, sigma=5. / 3, stride=5, padding=5)
