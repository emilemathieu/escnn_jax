...
class RestrictionModule(EquivariantModule):
    ...
    def __init__(self, in_type: FieldType, id):
        ...
        This module only acts as a wrapper for :meth:`escnn.nn.FieldType.restrict`
        (or :meth:`escnn.nn.GeometricTensor.restrict`).
        The accepted values of ``id`` depend on the underlying ``gspace`` in the input type ``in_type``; check the
        documentation of the method :meth:`escnn.gspaces.GSpace.restrict` of the gspace used for
        further information.
        
        
        .. seealso::
            :meth:`escnn.nn.FieldType.restrict`,
            :meth:`escnn.nn.GeometricTensor.restrict`,
            :meth:`escnn.gspaces.GSpace.restrict`
    ...
    def forward(self, input: GeometricTensor) -> GeometricTensor:
        ...
        return GeometricTensor(input.tensor, self.out_type, input.coords)
